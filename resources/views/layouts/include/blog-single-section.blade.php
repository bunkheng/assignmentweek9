          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="{{ route('blog-single') }}">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{ route('blog-single') }}"><time datetime="2020-01-01">Jan 1, 2020</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{ route('blog-single') }}">12 Comments</a></li>
                </ul>
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="{{ route('blog-single') }}">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="{{ route('blog-single') }}">Et dolores corrupti quae illo quod dolor</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>
